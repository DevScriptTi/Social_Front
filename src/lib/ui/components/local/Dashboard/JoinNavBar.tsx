...
export default async function JoinNavBar() {
    ...
    return (
        <div className="h-full flex justify-center gap-8  flex-col w-1/3">
            <NavJoinItem currentStep={step} step={0} disabled={false}  title={t('step0')} href={`/${locale}/join`} />
            ...
            <NavJoinItem currentStep={step} step={6} disabled={false}  title={t('step6')} href={`/${locale}/join/step6`} />
        </div>
    )
}
