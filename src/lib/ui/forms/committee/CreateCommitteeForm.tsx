...
import { createCommittee } from "@/lib/server/actions/committee/committeeActions";
...
import { CreateCommitteeRequest } from "@/lib/server/types/committee/committee";
import { Wilaya, getWilayas } from "@/lib/server/actions/committee/getWilayas";
...
export default function CreateCommitteeForm() {
    ...
    const {
        ...
        watch,
        reset,
    } = useForm<CreateCommitteeFormData>({
    ...
    const onSubmit = async (data: CreateCommitteeFormData) => {
        try {
